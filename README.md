...
<p align="center">
<img src="client/imgs/dashboard.png" alt="Dashboard page" width="40%">
<img src="client/imgs/login.png" alt="Login page" width="40%">
<img src="client/imgs/transaction page.png" alt="Transaction page" width="40%">
<img src="client/imgs/contacts page.png" alt="Contacts page" width="40%">
</p>
...
<p align="center">
<img src="client/imgs/start9systemmenu.png" alt="System menu" width="50%">
</p>

3. Browse to the the downloaded phoenixd-lightning-wallet-ui.s9pk and install
<p align="center">
<img src="client/imgs/start9sideload.png" alt="System menu" width="50%">
</p>
...
<p align="center">
<img src="client/imgs/goToCommunityStore.png" alt="System menu" width="50%">
</p>

2. Add the Phoenixd Wallet Community App Store link
<code>https://github.com/hkarani/umbrel-community-app-store </code>
<p align="center">
<img src="client/imgs/add-community-app-store-link.png" alt="System menu" width="50%">
</p>

3.Open the community store and select Phoenixd Lightning Wallet
<p align="center">
<img src="client/imgs/open-the-community-store.png" alt="System menu" width="50%">
</p>

3. Install app and open to start
<p align="center">
<img src="client/imgs/install-app.png" alt="System menu" width="50%">
</p>
